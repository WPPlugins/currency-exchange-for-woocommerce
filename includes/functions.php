...
if( ! function_exists( 'br_ce_general_display_callback' ) ) {
    /**
     * Function for buttons settings callback
     *
     * @return void
     */
    function br_ce_general_display_callback() { 
        include CE_TEMPLATE_PATH . "general_settings.php";
    }
}
...
if ( ! function_exists( 'berocket_font_select_upload' ) ) {
    ...
    function berocket_font_select_upload( $text, $id, $name, $value, $show_fa = true, $show_upload = true, $show_remove = true, $data_sc = '' ) {
        ...
        if ( $show_fa ) {
            $result .= '<input type="button" class="berocket_aapf_font_awesome_icon_select button" value="'.__('Font awesome', 'BeRocket_CE_domain').'"/>
        ...
        if ( $show_upload ) {
            $result .= '<input type="button" class="berocket_aapf_upload_icon button" value="'.__('Upload', 'BeRocket_CE_domain').'"/> ';
        }
        if ( $show_remove ) {
            $result .= '<input type="button" class="berocket_aapf_remove_icon button" value="'.__('Remove', 'BeRocket_CE_domain').'"/>';
        }
        $result .= '</div>';
